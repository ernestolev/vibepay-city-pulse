...
export const VIBES: Record<VibeKey, VibeOffer> = {
  ...
  event: {
    ...
    vibe: "event",
    title: "Marktplatz crowd, local bistro perk",
    merchant: "Trattoria Marktplatz · family since 1994",
    description:
      "A festival nearby is bringing shoppers into Old Town. VibePay highlights an independent bistro with a special menu — settled via Payone Riel.",
    discount: "15% OFF",
    cashback: "+ €1.50 cashback",
    pattern: "confetti",
    icon: Utensils,
    weatherIcon: Utensils,
    weatherLabel: "Local hotspot",
    tagline: "Festival nearby, local bistros benefiting",
